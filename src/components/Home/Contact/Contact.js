            ...
            <div className="aboutFooter container-fluid">
                <div className="row ">
                    <div className="col-md-3 ml-5 mt-5 footerLogo">
                        <a className="fw-bold fs-4 text-dark" href="#about" style={{ fontFamily: 'Dancing Script, cursive' }}>MINHAJUL</a>
                    </div>
                        ...
                        <form className="contact-form" onSubmit={sendEmail}>
                            <div className="row">
                                <div class="mb-3 col-md-5">
                                    <label for="exampleInputEmail1" class="form-label fw-bold text-dark">Name</label>
                                    <input type="text" class="form-control" name='contact_number' />

                                </div>
                                <div class="mb-3 col-md-5">
                                    <label for="exampleInputEmail1" class="form-label fw-bold text-dark">Email</label>
                    ...
                    <div style={{ fontSize: "20px", fontFamily: 'roboto' }} className="col-md-3 mt-5 text-dark">
                        <h5>GET IN TOUCH</h5>
                        <hr />
                ...
                <div className="row mt-5 ">
                    <div style={{ fontFamily: 'roboto' }} className="col-md-5 ml-5 mt-5 text-dark">
