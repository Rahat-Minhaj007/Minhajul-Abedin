    ...
    return (
        <section id='about' className="about-container container py-5  mt-5">
            <div className="row d-flex justify-content-between">
                ...
                <div className="col-md-6 aboutContent mt-4 " data-aos="zoom-in-up">
                    ...
                    <div className="d-flex ">
                        ...
                        <div>
                            <a href="mailto:rahatminhaj444@gmail.com" target='_blank' style={{ fontFamily: 'poppins', color: 'black' }} rel="noreferrer"><button className="btn btn-brand text-uppercase mt-3 ms-5"><strong><FontAwesomeIcon icon={faEnvelope} /> Contact Me</strong></button>
                            </a>
                        </div>
                    </div>
                </div>
